#!/usr/bin/env python3
"""Simple fetch script that outputs results to stdout."""
...
try:
    ...
    with open('/data/research/comfymcp/raw_html.txt', 'w') as f:
        f.write(html)
    print("Saved raw HTML to raw_html.txt")

    # Print first 5000 characters for analysis
